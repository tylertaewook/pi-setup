...
description: Production-ready CSS transitions for web apps. Use when implementing or animating notification badges, dropdowns, menus, modals, panel reveals, page transitions, card resizes/hover tilt, number pop-ins and spinning counters, text/icon swaps, success checks, avatar group hovers, error shakes, search/input clear, skeleton loaders and shimmer, sliding tabs and segmented controls, tooltips, staggered text reveals, plus-to-menu morphs, accordions and collapsibles, toasts and banner stacks, like buttons, learn-more hovers, checkboxes, toggles, AI thinking states, reasoning streams, streaming text, or matrix dot loaders. Triggers on "add a transition", "animate the dropdown", "make the modal open smoothly", "make it animate", "fade between", "page slide", "stagger animation", "hover lift", "shake on invalid", "expand / collapse", "motion tokens", "scan for ad-hoc transitions", "tokenize my animations", and the commands transitions reveal, transitions review, transitions apply, transitions refine.
---
